package com.nvdung1607.countdayleave.widget
        ...
        fun updateAppWidget(
            ...
            coroutineScope.launch {
                ...
                if (event == null) {
                    ...
                    views.setTextViewText(R.id.widget_days, "❓")
                    views.setTextViewText(R.id.widget_days_label, "NHẤP ĐỂ ĐỔI SỰ KIỆN")
                    views.setTextViewText(R.id.widget_target_date, "")
                    views.setTextViewText(R.id.widget_quote, "")
                ...
                val intent = Intent(context, MainActivity::class.java).apply {
                    action = "countdown"
                    putExtra(com.nvdung1607.countdayleave.notification.NotificationScheduler.EXTRA_EVENT_ID, event.id)
                    flags = Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TOP
                }
